...
################################################################
# This is a generated script based on design: design_hotcache
#
...
# source design_hotcache_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# C, C, C, C, chip_select_splitter, data_splitter, hcm, mpc106fsm, mux_block, mx9_sdramfsm, powerpcfsm, validity_block
...
set design_name design_hotcache
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mux_block_0, and set properties
  set block_name mux_block
  set block_cell_name mux_block_0
  if { [catch {set mux_block_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux_block_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: validity_block_0, and set properties
  set block_name validity_block
  set block_cell_name validity_block_0
  if { [catch {set validity_block_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $validity_block_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net CLK_0_1 [get_bd_ports CLK_0] [get_bd_pins hcm_0/CLK] [get_bd_pins mpc106fsm_0/CLK] [get_bd_pins mux_block_0/CLK] [get_bd_pins mx9_sdramfsm_0/CLK] [get_bd_pins powerpcfsm_0/CLK] [get_bd_pins validity_block_0/CLK]
  connect_bd_net -net C_0_val [get_bd_pins C_0/val] [get_bd_pins validity_block_0/C0]
  connect_bd_net -net C_1_val [get_bd_pins C_1/val] [get_bd_pins validity_block_0/C1]
  connect_bd_net -net C_2_val [get_bd_pins C_2/val] [get_bd_pins validity_block_0/C2]
  connect_bd_net -net C_3_val [get_bd_pins C_3/val] [get_bd_pins validity_block_0/C3]
  ...
  connect_bd_net -net data_splitter_0_d_out [get_bd_pins data_splitter_0/d_out] [get_bd_pins hcm_0/value] [get_bd_pins mx9_sdramfsm_0/DQ]
  connect_bd_net -net hcm_0_mux_out [get_bd_pins hcm_0/mux_out] [get_bd_pins mux_block_0/mux]
  ...
  connect_bd_net -net mpc106fsm_0_SDMA [get_bd_pins hcm_0/address] [get_bd_pins mpc106fsm_0/SDMA] [get_bd_pins mx9_sdramfsm_0/A]
  ...
  connect_bd_net -net mpc106fsm_0_WE [get_bd_pins hcm_0/WE] [get_bd_pins mpc106fsm_0/WE] [get_bd_pins mx9_sdramfsm_0/WE]
  connect_bd_net -net mux_block_0_C0 [get_bd_pins C_0/E] [get_bd_pins mux_block_0/C0]
  connect_bd_net -net mux_block_0_C1 [get_bd_pins C_1/E] [get_bd_pins mux_block_0/C1]
  connect_bd_net -net mux_block_0_C2 [get_bd_pins C_2/E] [get_bd_pins mux_block_0/C2]
  connect_bd_net -net mux_block_0_C3 [get_bd_pins C_3/E] [get_bd_pins mux_block_0/C3]
  ...
  connect_bd_net -net powerpcfsm_0_TS [get_bd_pins mpc106fsm_0/TS] [get_bd_pins mpc106fsm_0/TSIZ] [get_bd_pins powerpcfsm_0/TS]
  connect_bd_net -net powerpcfsm_0_WT [get_bd_pins mpc106fsm_0/WT] [get_bd_pins powerpcfsm_0/WT]
  connect_bd_net -net validity_block_0_mux [get_bd_pins hcm_0/mux_in] [get_bd_pins validity_block_0/mux]

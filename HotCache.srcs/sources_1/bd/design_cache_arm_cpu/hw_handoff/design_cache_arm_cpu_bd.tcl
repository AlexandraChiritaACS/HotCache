...
################################################################
# This is a generated script based on design: design_cache_arm_cpu
#
...
# source design_cache_arm_cpu_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ARM_CPU, Data_Memory, IC
...
set design_name design_cache_arm_cpu
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ARM_CPU_0_control_memread_out [get_bd_pins ARM_CPU_0/control_memread_out] [get_bd_pins Data_Memory_0/CONTROL_MemRead]
  connect_bd_net -net ARM_CPU_0_control_memwrite_out [get_bd_pins ARM_CPU_0/control_memwrite_out] [get_bd_pins Data_Memory_0/CONTROL_MemWrite]
  connect_bd_net -net ARM_CPU_0_mem_address_out [get_bd_pins ARM_CPU_0/mem_address_out] [get_bd_pins Data_Memory_0/inputAddress]
  connect_bd_net -net ARM_CPU_0_mem_data_out [get_bd_pins ARM_CPU_0/mem_data_out] [get_bd_pins Data_Memory_0/inputData]

...
//Command     : generate_target hot_cache_design.bd
//Design      : hot_cache_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "hot_cache_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=hot_cache_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=12,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "hot_cache_design.hwdef" *) 
module hot_cache_design
   (CLK_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_0, CLK_DOMAIN hot_cache_design_CLK_0, FREQ_HZ 500000000, INSERT_VIP 0, PHASE 0.000" *) input CLK_0;
  ...
  hot_cache_design_C_0_0 C_0
       (.E(mux_block_0_C0),
        .val(C_0_val));
  hot_cache_design_C_1_0 C_1
       (.E(mux_block_0_C1),
        .val(C_1_val));
  hot_cache_design_C_2_0 C_2
       (.E(mux_block_0_C2),
        .val(C_2_val));
  hot_cache_design_C_3_0 C_3
       (.E(mux_block_0_C3),
        .val(C_3_val));
  hot_cache_design_chip_select_splitter_0_0 chip_select_splitter_0
       (.a(mpc106fsm_0_CS),
        .b(chip_select_splitter_0_b));
  hot_cache_design_data_splitter_0_0 data_splitter_0
       (.d_in(powerpcfsm_0_DH),
        .d_out(data_splitter_0_d_out));
  hot_cache_design_hcm_0_0 hcm_0
       (.CLK(CLK_0_1),
        .WE(mpc106fsm_0_WE),
  ...
  hot_cache_design_mpc106fsm_0_0 mpc106fsm_0
       (.A(powerpcfsm_0_A),
        ...
        .WE(mpc106fsm_0_WE),
        .WT(powerpcfsm_0_WT));
  hot_cache_design_mux_block_0_0 mux_block_0
       (.C0(mux_block_0_C0),
        .C1(mux_block_0_C1),
        .C2(mux_block_0_C2),
        .C3(mux_block_0_C3),
        .CLK(CLK_0_1),
        .mux(hcm_0_mux_out));
  hot_cache_design_mx9_sdramfsm_0_0 mx9_sdramfsm_0
       (.A(mpc106fsm_0_SDMA),
        ...
        .WE(mpc106fsm_0_WE));
  hot_cache_design_powerpcfsm_0_0 powerpcfsm_0
       (.A(powerpcfsm_0_A),
        .AACK(mpc106fsm_0_AACK),
        .ARTRY(mpc106fsm_0_ARTRY),
        .BG(mpc106fsm_0_BG0),
        ...
        .TSIZ(powerpcfsm_0_TSIZ),
        .WT(powerpcfsm_0_WT));
  hot_cache_design_validity_block_0_0 validity_block_0
       (.C0(C_0_val),
        .C1(C_1_val),
        .C2(C_2_val),
        .C3(C_3_val),
